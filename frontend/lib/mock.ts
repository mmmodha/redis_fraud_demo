...
const ALEX_TRACE: AgentTrace = {
  ...
  steps: [
    ...
    step({ component: "feature_store", tool: "get_geo_entropy", input: { customer_id: "cust_alex" }, output_summary: "Geo entropy 0.92 — impossible-travel pattern (Seattle → São Paulo in 4h).", output_data: { entropy: 0.92, impossible_travel: true }, latency_ms: 7, redis_keys_touched: ["card:card_alex_visa:features"] }),
